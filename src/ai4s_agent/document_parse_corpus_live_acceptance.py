...
def _preflight_binding(
    *,
    ...
    return load_and_bind_preflight_report(
        preflight_report_path=preflight_report_path,
        preflight_artifact_sha256=preflight_artifact_sha256,
        require_preflight_match=require_preflight_match,
        expected_origin=expected_origin,
        endpoint_profile_summary=endpoint_profile_summary,
        expected_protocol_version=_EXPECTED_PROTOCOL_VERSION,
        failure_message="preflight report does not match this live acceptance endpoint",
    )
...
def _contains_credential_marker(value: str) -> bool:
    return contains_credential_marker(value)
