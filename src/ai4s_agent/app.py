...
from ai4s_agent.planner import (
    AtomicTaskRegistry,
    br2_real_tool_observability_smoke_task_registry_v1,
...
def create_app(
    ...
    if scientific_task_registry is None:
        ...
        elif registry_id == "br2-real-tool-observability-smoke-v1":
            scientific_task_registry = br2_real_tool_observability_smoke_task_registry_v1()
        elif registry_id:
