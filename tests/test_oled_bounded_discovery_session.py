...
from tests.test_oled_inverse_design import (
    _configure_private_remote_profile,
    _remote_reinvent4_template,
    _source_csv,
)
...
def test_remote_generation_known_hosts_remains_bound_through_evaluation(
    ...
    profile_id = "molly-compute-main-compute_worker_main-reinvent4-v1"
    known_hosts = _configure_private_remote_profile(
        tmp_path=tmp_path,
        monkeypatch=monkeypatch,
        profile_id=profile_id,
        ssh_target="molly-compute-main",
    ...
    def fake_transport(
        ...
        *,
        ...
        assert run_id
        assert count == 1
        assert payload["remote_host"] == "molly-compute-main"
