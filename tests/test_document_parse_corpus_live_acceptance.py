...
def test_corpus_live_acceptance_records_endpoint_profile_metadata(tmp_path: Path) -> None:
    ...
    report = run_document_parse_corpus_live_acceptance(
        ...
        endpoint_profile_summary={
            "endpoint_profile_name": "gpu_worker_main-loopback",
            ...
            "routing_fallback_profile_names": ["gpu_worker_main-backup"],
        },
    )

    assert report.decision == "awaiting_confirmation"
    assert report.endpoint_profile.endpoint_profile_name == "gpu_worker_main-loopback"
    ...
    assert report.endpoint_profile.routing_fallback_profile_names == ["gpu_worker_main-backup"]
