...
The run did not use gpu_worker_main, execute REINVENT4, mutate the material Registry, or
...
gpu_worker_main's remote REINVENT4 transport when sufficient GPU capacity is available.
