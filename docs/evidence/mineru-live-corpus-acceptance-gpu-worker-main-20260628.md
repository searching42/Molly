# GPU worker MinerU Live Corpus Acceptance Evidence - 2026-06-28

This document records a redacted evidence summary for the manual MinerU live
corpus acceptance run on gpu_worker_main. It intentionally does not include generated
...
| SSH target used | private alias `molly-gpu-main` |
...
The service was started from the `mineru34` conda environment on gpu_worker_main. The
...
This avoids a vLLM FlashInfer sampler startup failure on the gpu_worker_main RTX 5090
GPU (`SM 12.0`).
