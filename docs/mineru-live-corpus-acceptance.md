...
metadata, and gpu_worker_main-oriented CUDA/vLLM environment diagnostics. It does not
...
This is the recommended shape for gpu_worker_main-style manual runs: start MinerU on the
