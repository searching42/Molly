# Historical OPEN Issue Register

> **Non-normative historical record.** This migrated register preserves stable
> `OPEN-*` identifiers and implementation evidence used by tests and technical
> documents. It does not define current work, status, or execution order; see
> `todo.md`. Unlinked PR and issue numbers below refer to the pre-migration
> private audit archive unless an explicit public GitHub URL is present.
