...
| `M1-012` 第二轮 PR-AS 成功但 Session revision 未提交时 reconciliation | `I/T(partial)/—` | `READY` | PR-BB fault-injection test |
| `M1-013` PR-ATb 成功注册后重启且不重复调用 adapter | `I/T(partial)/—` | `READY` | PR-BB PR-ATb 定点 fault-injection test |
...
| `M1-001`～`M1-011` | #393 | runtime: `86f554c7510d5c92b7f8cb91cfcb90094d27632f`; evidence introduced: `a939f089e7861ee5fd0fac1a70503261a71c318a`; merge: pending | `docs/evidence/oled-paper018-pr-ba-local-two-round-session-canary-20260723.md` | local two-round runtime validated |
