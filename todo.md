...
| `M3H-013` Structured Dataset Canary | `I/T(partial)/—` | `BLOCKED` | PR #30 reviewed HEAD `34a4438e31c054f01d77e58b86c14dc21111ccde`、squash merge `a28ea6fe19db9c81e43a40174498c636bd0f1bf8` 的 v3 real-tool runtime bridge 已合入；PR #31 reviewed HEAD `1eb6bf87083eeb286c28e5436c7af4c72b9a9356`、squash merge `19ae10a1c866964d6b993c7dfd100e930127acde` 的 applicability preflight contract 已合入。PR #33 实际 merge commit `5307dd7c446aee21c4d0d026b1e1d94d9b628236` 上完成 post-merge authority rebind：matching worker `sha256:1445ee01fbb3748caea3ddf889726df48ad36d49e0bfb66b3d079d93d6f3aa72`、`unimol-tools 0.1.5`、`unimol-train-br1-v2`，fresh read-only preflight `PASS`，`1999/1999/0/0`，reason/mapping diagnostics 为空；report/summary verifier 与固定时间 exact replay 通过。已冻结 exact Raw CSV、source manifest、mapping policy 为 Registry-bound candidate package `br1-post-merge-freeze-5307dd7-v1`，proposal 为 `br1-owner-proposal-5307dd7-v1`，当前 `WAITING_OWNER`。Stage C 在 Controller decision 前发现重复 source-binding 名称，未创建 clean acceptance；PR #35 正基于 PR #34 merge `1636c3430e035ed6c2a19babe45c4331938ece5a`，将 Controller policy 升级为 v2，加入 bounded digest-derived source-binding name identity、order-independent roster binding、duplicate exact source fact fail-closed 及 decision-before-effect/no-dispatch regression coverage；最新 owner review 发现历史 policy-v1 execution 读取兼容性 blocker，本 follow-up 已补齐 v1 read-only / v2 writer-only / mutation fail-closed 与 mixed-version regression，但 PR #35 仍为 Draft、尚未获得新的 owner acceptance 或 merge；合并后必须重新 materialize/rebind、fresh preflight、freeze 和 exact proposal，旧 proposal approval 不延伸。无 acceptance ID/run、无 review snapshot、无 Confirmed Dataset、无 Gate、无 training/generation/prediction/ranking；该阶段不标 `V` 或 `DONE`，不推进 BR2` |
