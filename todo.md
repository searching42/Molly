...
| `M1-012`～`M1-013` | #394 | PR-AV tests: `bbe68d92c4fedcecd13d62c984ea10acab0bc848`; PR-AW recovery: pending head; merge: pending | `tests/test_oled_bounded_discovery_session.py`, `tests/test_oled_bounded_discovery_session_api.py` | second-round Session and control-plane reconciliation tested |
